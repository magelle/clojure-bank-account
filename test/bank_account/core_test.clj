...
(deftest account-test
  ...
  (testing "make a deposit should add an operation in account"
    (is (= (deposit (newAccount) 1000 (fn [] "01-01-2019")) (list (new-operation "01-01-2019" 1000)))))
  (testing "make a withdrawal should add an operation in account"
    (is (= (withdraw (newAccount) 1000 (fn [] "01-01-2019")) (list (new-operation "01-01-2019" -1000))))))
...
(deftest print-statement-test
  (testing "an empty account should have only the headers"
    (is (= (print-statement (newAccount)) "Date | Amount\n")))
  (testing "statement of a deposit"
    (is (= (print-statement (deposit (newAccount) 300 (fn [] "01-01-2019"))) "Date | Amount\n01-01-2019 | 300")))
  (testing "statement of a withdraw"
    (is (= (print-statement (withdraw (newAccount) 300 (fn [] "01-01-2019"))) "Date | Amount\n01-01-2019 | -300")))
